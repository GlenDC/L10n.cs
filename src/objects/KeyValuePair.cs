...
namespace L20nCore
{
	...
	{
		/// <summary>
		/// The <see cref="L20nCore.Objects.KeyValuePair"/> represents a single attribute
		/// containing a <see cref="L20nCore.Objects.L20nObject"/> value and optionally an index.
		/// </summary>
		public sealed class KeyValuePair : L20nObject
		{
			/// <summary>
			/// Initializes a new instance of the <see cref="L20nCore.Objects.HashValue"/> class.
			/// </summary>
			public KeyValuePair(L20nObject value, L20nObject index)
			{
				m_Value = value;
				m_Index = index;
			}
			...
			/// in case the value is a <see cref="L20nCore.Objects.HashValue"/>.
