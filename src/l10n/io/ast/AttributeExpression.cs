	...
	namespace L10n
	{
		namespace IO
		{
			namespace AST
			{
				...
				/// More Information: <see cref="L20nCore.L10n.IO.Parsers.Expressions.Attribute"/>.
				/// </summary>
				public sealed class AttributeExpression : INode
				{
					...
					public L10n.Objects.L10nObject Eval()
					{
						...
						var attributeExpression = new L10n.Objects.AttributeExpression(root, identifier, propertyExpression);
