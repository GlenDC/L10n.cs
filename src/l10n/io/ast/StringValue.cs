	...
	namespace L10n
	{
		namespace IO
		{
			namespace AST
			{
				...
				/// More Information: <see cref="L20nCore.L10n.IO.Parsers.StringValue"/> 
				/// </summary>
				public sealed class StringValue : INode
				{
					...
					public StringValue(L10n.IO.Parsers.Quote.Info quote)
					{
						m_Quote = quote;
						m_Value = "";
					...
					{
						var expressions = new L10n.Objects.L10nObject[m_Expressions.Count];
						...
						return new L10n.Objects.StringValue(value, expressions).Optimize();
					}
					...
					private readonly L10n.IO.Parsers.Quote.Info m_Quote;
