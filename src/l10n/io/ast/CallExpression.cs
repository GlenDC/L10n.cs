	...
	namespace L10n
	{
		namespace IO
		{
			namespace AST
			{
				...
				/// More Information: <see cref="L20nCore.L10n.IO.Parsers.Expressions.Call"/>
				/// </summary>
				public sealed class CallExpression : INode
				{
					...
					{
						var name = ((L10n.Objects.Identifier)m_Name.Eval()).Value;
						var parameters = new L10n.Objects.L10nObject[m_Parameters.Count];
						for (int i = 0; i < parameters.Length; ++i)
							parameters [i] = m_Parameters [i].Eval();

						return new L10n.Objects.CallExpression(name, parameters).Optimize();
					}
