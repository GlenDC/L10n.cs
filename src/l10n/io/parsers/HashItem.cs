	...
	namespace L10n
	{
		namespace IO
		{
			namespace Parsers
			{
				...
				{
					public static L10n.IO.AST.HashValue.Item Parse(CharStream stream)
					{
						...
						try
						{
							...
							return new L10n.IO.AST.HashValue.Item(identifier, value, isDefault);
						} catch (Exception e)
						{
					...
					public static bool PeekAndParse(CharStream stream, out L10n.IO.AST.HashValue.Item item)
					{
