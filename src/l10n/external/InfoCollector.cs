...
namespace L20nCore
{
	namespace L10n
	{
		namespace External
		{
			...
			/// <see cref="L20nCore.L10n.External.IHashValue"/>.
			/// </summary>
			public sealed class InfoCollector
			{
				...
				/// <summary>
				/// Initializes a new instance of the <see cref="L20nCore.L10n.External.InfoCollector"/> class.
				/// </summary>
				public InfoCollector()
				{
					m_Info = new Dictionary<string, L10nObject>();
				}

				/// <summary>
				/// Add a <see cref="L20nCore.L10n.Objects.Literal"/> value with the given <c>name</c>.
				/// </summary>
				...
				/// <summary>
				/// Add a <see cref="L20nCore.L10n.Objects.StringOutput"/> value with the given <c>name</c>.
				/// </summary>
				...
				/// <summary>
				/// Add a <see cref="L20nCore.L10n.Objects.BooleanValue"/> value with the given <c>name</c>.
				/// </summary>
				...
				/// <summary>
				/// Add a <see cref="L20nCore.L10n.Objects.DelegatedLiteral+Delegate"/> value with the given <c>name</c>.
				/// </summary>
				...
				/// <summary>
				/// Add a <see cref="L20nCore.L10n.Objects.DelegatedString+Delegate"/> value with the given <c>name</c>.
				/// </summary>
				...
				/// <summary>
				/// Add a <see cref="L20nCore.L10n.Objects.DelegatedBoolean+Delegate"/> value with the given <c>name</c>.
				/// </summary>
				...
				/// <summary>
				/// Add a <see cref="L20nCore.L10n.External.IHashValue"/> value with the given <c>name</c>.
				/// </summary>
				...
				/// <summary>
				/// Collects all the added info and returns it as a <see cref="L20nCore.L10n.Objects.HashValue"/>.
				/// THIS SHOULD NOT BE CALLED BY THE CLASS THAT IMPLEMENTS <see cref="L20nCore.L10n.External.IHashValue"/>!
				/// </summary>
				...
				private void AddObject(string name, L10nObject value)
				{
				...
				private readonly Dictionary<string, L10nObject> m_Info;
			}
		}
	}
}
