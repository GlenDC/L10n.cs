...
namespace L20nCore
{
	namespace L10n
	{
		...
		/// using your provided localization (l10n) files.
		/// </summary>
		public sealed class Translator
		{
			...
			/// <summary>
			/// Initializes a new instance of the <see cref="L20nCore.L10n.Translator"/> class.
			/// </summary>
			public Translator()
			{
				m_Manifest = new Manifest();
				m_Globals = new Dictionary<string, Objects.L10nObject>();
			...
			public void ImportManifest(string path)
			{
				...
				Logger.CurrentLocale = CurrentLocale;
			}
			...
			public string Translate(string id)
			{
				...
				{
					Logger.WarningFormat(TRANSLATION_EXCEPTION_MESSAGE, id, e.ToString());
					return id;
				}
			}
			...
			/// Any <see cref="System.Exception"/> gets captured and turned into an unexpected warning.
			/// </summary>
			public string Translate(string id, List<string> keys, List<Objects.L10nObject> values)
			{
				try
				{
			...
			/// <summary>
			/// Add the given <see cref="L20nCore.L10n.Objects.Literal"/> <c>value</c> as the global
			...
			/// <summary>
			/// Add the given <see cref="L20nCore.L10n.Objects.StringOutput"/> <c>value</c> as the global
			/// with name equal to the value of params <c>id</c>.
			/// </summary>
			...
			/// <summary>
			/// Add the given <see cref="L20nCore.L10n.Objects.BooleanValue"/> <c>value</c> as the global
			/// with name equal to the value of params <c>id</c>.
			/// </summary>
			...
			/// <summary>
			/// Add the given <see cref="L20nCore.L10n.External.IHashValue"/> <c>value</c> as the global
			/// with name equal to the value of params <c>id</c>.
			/// </summary>
			...
			/// <summary>
			/// Add the given <see cref="L20nCore.L10n.Objects.DelegatedLiteral+Delegate"/> <c>callback</c>
			...
			/// <summary>
			/// Add the given <see cref="L20nCore.L10n.Objects.DelegatedString+Delegate"/> <c>callback</c>
			/// as the global with name equal to the value of params <c>id</c>.
			/// </summary>
			...
			/// <summary>
			/// Add the given <see cref="L20nCore.L10n.Objects.DelegatedBoolean+Delegate"/> <c>callback</c>
			/// as the global with name equal to the value of params <c>id</c>.
			/// </summary>
			...
			/// <summary>
			/// Add the given <see cref="L20nCore.L10n.Objects.L10nObject"/> <c>value</c>
			/// as the global with name equal to the value of params <c>id</c>.
			/// </summary>
			public void AddGlobal(string id, Objects.L10nObject value)
			{
				if (value == null)
				{
					Logger.WarningFormat(
			...
			/// </summary>
			public void SetWarningDelegate(Logger.LogDelegate callback)
			{
				Logger.SetWarningCallback(callback);
			}

			private string Translate(string id, string key_a, Objects.L10nObject value_a)
			{
				try
				{	
					// Get either the current or default locale, throw a warning otherwise.
			...
			private string Translate(string id, string key_a, string key_b, Objects.L10nObject value_a, Objects.L10nObject value_b)
			{
				try
				{	
					// Get either the current or default locale, throw a warning otherwise.
			...
			private void ImportLocal(string id, out LocaleContext context, LocaleContext parent)
			{
				...
				switch (m_Manifest.Version)
				{
					...
					default:
						throw new ImportException(
							String.Format("{0} is a recognized version, but not valid using this Translator.",
					              m_Manifest.Version));
				}
			...
			private readonly Dictionary<string, Objects.L10nObject> m_Globals;
