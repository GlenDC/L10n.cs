...
namespace L20nCore
{
	namespace L10n
	{
		...
		{
			/// <summary>
			/// The <see cref="L20nCore.L10n.Objects.HashValue"/> represents a hash table
			/// containing <see cref="L20nCore.L10n.Objects.L10nObject"/> values matched with a hash.
			...
			public sealed class HashValue : Primitive
			{
				...
				/// </summary>
				public HashValue(Dictionary<string, L10nObject> items, string def)
				{
				...
				/// as this might break L10n DSL Logic as defined by the Translator.
				/// </summary>
				/// <remarks>
				...
				/// not a <see cref="L20nCore.L10n.Objects.Primitive"/> value type.
				/// </summary>
