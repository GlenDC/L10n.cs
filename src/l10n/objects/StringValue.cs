...
namespace L20nCore
{
	namespace L10n
	{
		...
		{
			/// <summary>
			/// The <see cref="L20nCore.L10n.Objects.StringValue"/> class is a
			/// <see cref="L20nCore.L10n.Objects.Primitive"/> L20n Object Type
			/// and can therefore be evaluated to a <see cref="L20nCore.L10n.Objects.StringOutput"/> value.
			///
			...
			public sealed class StringValue : Primitive
			{
				...
				private readonly L10nObject[] m_Expressions;
				...
				/// <summary>
				/// Initializes a new instance of the <see cref="L20nCore.L10n.Objects.StringValue"/> class
				/// with the format string (<c>value</c>) and the <c>expressions</c>
				/// given by the callee of this constructor.
				/// </summary>
				public StringValue(string value, L10nObject[] expressions)
				{
					m_Value = value;
				...
				/// <summary>
				/// Evaluate all the expressions contained in this <see cref="L20nCore.L10n.Objects.StringValue"/>
				/// and use the results of these evaluations as the variables used in the evaluation
				/// of the format string to compute the final result value as a <see cref="L20nCore.L10n.Objects.StringOutput"/>.
				/// </summary>
				...
				/// <summary>
				/// Evaluates (this.Eval) this <see cref="L20nCore.L10n.Objects.StringValue"/> and returns
				...
				/// on the expanders that are usd within L10n StringValues.
				/// </summary>
				/// <remarks>
				...
				private string FormatString(string format, string[] argv)
				{
					for (int i = 0; i < argv.Length; ++i)
						...
						String.Format("{{ {1}{0}{1} }}", i, L10n.IO.AST.StringValue.DummyExpressionCharacter),
						argv [i]);
					return format;
				}
			}
