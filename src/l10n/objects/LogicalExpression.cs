...
namespace L20nCore
{
	namespace L10n
	{
		...
		{
			/// <summary>
			/// <see cref="L20nCore.L10n.Objects.LogicalExpression"/> represents the binary
			/// expressions: 'And' and 'Or'. These expression wrap around 2 L20nObjects
			/// that get/should be evaluated to <see cref="L20nCore.L10n.Objects.BooleanValue"/> results,
			/// and return a new <see cref="L20nCore.L10n.Objects.BooleanValue"/> with the result of its expression. 
			/// </summary>
			public abstract class LogicalExpression : L10nObject
			{	
				/// <summary>
				/// Initializes a new instance of the <see cref="L20nCore.L10n.Objects.LogicalExpression"/> class.
				/// </summary>
				public LogicalExpression(L10nObject first, L10nObject second)
				{
					m_First = first;
					m_Second = second;
				}
				...
				/// using the evaluated results of the 2 wrapped L10nObject.
				...
				protected abstract L10nObject Operation(LocaleContext ctx);

				protected readonly L10nObject m_First;
				protected readonly L10nObject m_Second;
			}

			/// <summary>
			/// <see cref="L20nCore.L10n.Objects.AndExpression"/> represents the
			/// binary operation: And, and is applied on the evaluated results of
			/// the 2 wrapped up <see cref="L20nCore.L10n.Objects.L20nObject"/> values.
			/// </summary>
			public sealed class AndExpression : LogicalExpression
			{
				/// <summary>
				/// Initializes a new instance of the <see cref="L20nCore.L10n.Objects.AndExpression"/> class.
				/// </summary>
				public AndExpression(L10nObject a, L10nObject b)
			: base(a, b)
				{
				}
				...
				/// And Expression applied on the 2 wrapped <see cref="L20nCore.L10n.Objects.L10nObject"/> values.
				/// Returns <c>null</c> in case something went wrong.
				/// </summary>
				protected override L10nObject Operation(LocaleContext ctx)
				{
			...
			/// <summary>
			/// <see cref="L20nCore.L10n.Objects.OrExpression"/> represents the
			/// binary operation: Or, and is applied on the evaluated results of
			/// the 2 wrapped up <see cref="L20nCore.L10n.Objects.L10nObject"/> values.
			/// </summary>
			public sealed class OrExpression : LogicalExpression
			{
				/// <summary>
				/// Initializes a new instance of the <see cref="L20nCore.L10n.Objects.OrExpression"/> class.
				/// </summary>
				public OrExpression(L10nObject a, L10nObject b)
			: base(a, b)
				{
				}
				...
				/// <summary>
				/// Evaluates to a BooleanValue containing the result of the
				/// Or Expression applied on the 2 wrapped <see cref="L20nCore.L10n.Objects.L20nObject"/> values.
				/// Returns <c>null</c> in case something went wrong.
				/// </summary>
				protected override L10nObject Operation(LocaleContext ctx)
				{
