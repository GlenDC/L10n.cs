...
namespace L20nCore
{
	namespace L10n
	{
		namespace Objects
		{
			...
			/// different blocks of the L10n language.
			/// </summary>
			public abstract class L10nObject
			{
				...
				/// </summary>
				public abstract L10nObject Optimize();

				/// <summary>
				/// The <c>Eval</c> methods returns the result of the object and its content
				/// with optional access to the current <see cref="L20nCore.L10n.Internal.LocaleContext"/>
				/// and optional parameters given by the callee (the object owner, in most cases another L10nObject type).
				/// </summary>
				public abstract L10nObject Eval(LocaleContext ctx, params L10nObject[] argv);
			}
		}
	}
}
