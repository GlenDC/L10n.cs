...
namespace L20nCore
{
	namespace L10n
	{
		...
		{
			/// <summary>
			/// <see cref="L20nCore.L10n.Objects.PropertyExpression"/> represents a series of nested identifiers,
			/// meaning that we're looking for a value within 1 or multiple HashTables, starting with the name
			/// of the root <see cref="L20nCore.L10n.Objects.Entity"/>. 
			/// </summary>
			public sealed class PropertyExpression : L10nObject
			{
				/// <summary>
				/// Returns the series of nested identifiers,
				/// that is used by this <see cref="L20nCore.L10n.Objects.PropertyExpression"/>
				/// to look up the value in the (series of) hashtable(s).
				/// </summary>
				public L10nObject[] Identifiers
				{
					get { return m_Identifiers; }
				}

				/// <summary>
				/// Initializes a new instance of the <see cref="L20nCore.L10n.Objects.PropertyExpression"/> class.
				/// An exception gets thrown in case less than 2 identifiers is given,
				/// as that should never happen.
				/// </summary>
				public PropertyExpression(L10nObject[] identifiers)
				{
				...
				public PropertyExpression(string[] identifiers)
				{
					...
					m_Identifiers = new L10nObject[identifiers.Length];
				...
				public override L10nObject Eval(LocaleContext ctx, params L10nObject[] argv)
				{
					...
					L10nObject obj = maybe;

					// in case this property is pointing to a root entity,
					// directly requested by the L10n-user, we need to
					...
					for (; i < m_Identifiers.Length; ++i)
					{
						...
						if (stringObject != null)
						{
							...
							L10nObject alt = new IdentifierExpression(stringObject.Value);
				...
				/// </summary>
				private Entity GetEntity(LocaleContext ctx, L10nObject key)
				{
					// is it an identifier?
				...
				private readonly L10nObject[] m_Identifiers;
			}
		}
	}
}
