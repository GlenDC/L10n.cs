		...
		{	
			namespace L10n
			{
				...
				public static class Macro
				{
					...
					CharStream stream,
					string identifier, Internal.LocaleContext.L10nBuilder builder)
					{
						var startingPos = stream.Position;
					
						try
						{
							var macroAST = new AST.L10n.Macro(identifier);
					...
					{
						var variable = Expressions.Variable.Parse(stream) as AST.L10n.Variable;
						WhiteSpace.Parse(stream, true);
