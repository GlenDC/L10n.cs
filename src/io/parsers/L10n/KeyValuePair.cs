	...
	namespace IO
	{
		namespace Parsers
		{
			namespace L10n
			{
				...
				{
					public static AST.L10n.Attributes.Item Parse(CharStream stream)
					{
						...
						{	
							...
							return new AST.L10n.Attributes.Item(identifier, index, value);
						} catch (Exception e)
						{
							string msg = String.Format(
					...
					public static bool PeekAndParse(CharStream stream, out AST.L10n.Attributes.Item item)
					{
