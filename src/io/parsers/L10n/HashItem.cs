	...
	namespace IO
	{
		namespace Parsers
		{
			namespace L10n
			{
				...
				{
					public static AST.L10n.HashValue.Item Parse(CharStream stream)
					{
						...
						try
						{
							...
							return new AST.L10n.HashValue.Item(identifier, value, isDefault);
						} catch (Exception e)
						{
					...
					public static bool PeekAndParse(CharStream stream, out AST.L10n.HashValue.Item item)
					{
