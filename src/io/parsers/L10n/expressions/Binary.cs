				...
				namespace Expressions
				{
					...
					public static class Binary
					{
						...
						private class Chain
						{
							...
							public Chain(CharStream stream, AST.L10n.INode node, string op)
							{
							...
							public AST.L10n.INode Build()
							{
								return BuildRecursive(0, m_Nodes [0].Value);
							}

							private AST.L10n.INode BuildRecursive(int i, AST.L10n.INode previous)
							{
								...
								if (second.Op.IsSet)
								{
									...
									if (firstOp.Rank < secondOp.Rank)
									{
										...
										return new AST.L10n.BinaryOperation(
								...
								// otherwise we can simply evaluate as we would from left to right
									...
									{
										var binOp = new AST.L10n.BinaryOperation(
							...
							private class Node
							{
								...
								public AST.L10n.INode Value
								{
									get;
									private set;
								}
							
								public Node(AST.L10n.INode value, string op = null)
								{
									var operation =
							...
							{
								public AST.L10n.BinaryOperation.Operation Value
								{
									get;
									private set;
								}
								...
								public Operation(string raw)
								{
									...
									{
										case "==":
											Value = AST.L10n.BinaryOperation.Operation.IsEqual;
											Rank = 0;
											break;
									
										case "!=":
											Value = AST.L10n.BinaryOperation.Operation.IsNotEqual;
											Rank = 0;
											break;
									
										case "<":
											Value = AST.L10n.BinaryOperation.Operation.LessThan;
											Rank = 0;
											break;
									
										case ">": 
											Value = AST.L10n.BinaryOperation.Operation.GreaterThan;
											Rank = 0;
											break;
									
										case "<=":
											Value = AST.L10n.BinaryOperation.Operation.LessThanOrEqual;
											Rank = 0;
											break;
									
										case ">=":
											Value = AST.L10n.BinaryOperation.Operation.GreaterThanOrEqual;
											Rank = 0;
											break;
									
										case "*":
											Value = AST.L10n.BinaryOperation.Operation.Multiply;
											Rank = 2;
											break;
									
										case "/":
											Value = AST.L10n.BinaryOperation.Operation.Divide;
											Rank = 2;
											break;
									
										case "%":
											Value = AST.L10n.BinaryOperation.Operation.Modulo;
											Rank = 2;
											break;
									
										case "+":
											Value = AST.L10n.BinaryOperation.Operation.Add;
											Rank = 1;
											break;
									
										case "-":
											Value = AST.L10n.BinaryOperation.Operation.Subtract;
											Rank = 1;
											break;
