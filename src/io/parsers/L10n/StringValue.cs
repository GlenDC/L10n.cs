				...
				public static class StringValue
				{
					public static AST.L10n.INode Parse(CharStream stream)
					{
						...
						try
						{
							...
							var value = new AST.L10n.StringValue(quote);
							...
							while ((c = stream.PeekNext()) != '\0')
							{
								...
								} else if (c == '\n' || c == '\r') // newlines get converted to a space
								{
									...
									if (!Char.IsWhiteSpace(lc) && lc != AST.L10n.StringValue.DummyNewlineWhitespaceCharacter)
										value.appendChar(AST.L10n.StringValue.DummyNewlineWhitespaceCharacter);
								} else
								{
									...
									} else
									{
										...
										if (!Char.IsWhiteSpace(c)
											|| (lc != AST.L10n.StringValue.DummyNewlineWhitespaceCharacter
					...
					public static bool PeekAndParse(CharStream stream, out AST.L10n.INode value)
					{
