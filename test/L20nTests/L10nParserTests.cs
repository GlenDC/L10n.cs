...
namespace L20nCoreTests
{
	...
	public class L10nParserTests
	{
		...
		public void IdentifierExpressionTests()
		{
			...
			TypeAssert<L20nCore.IO.AST.L10n.Identifier>(
				IdentifierExpression.Parse(NC("identifier")));
			TypeAssert<L20nCore.IO.AST.L10n.Variable>(
				IdentifierExpression.Parse(NC("$normal_variable")));
			TypeAssert<L20nCore.IO.AST.L10n.Global>(
		...
		public void PrimaryExpressionTests()
		{
			...
			// literals
			TypeAssert<L20nCore.IO.AST.L10n.Literal>(
				Primary.Parse(NC("-42")));
			TypeAssert<L20nCore.IO.AST.L10n.Literal>(
				Primary.Parse(NC("+10")));
			TypeAssert<L20nCore.IO.AST.L10n.Literal>(
			...
			// string values
			TypeAssert<L20nCore.IO.AST.L10n.StringValue>(
			...
			// hash values
			TypeAssert<L20nCore.IO.AST.L10n.HashValue>(
				Primary.Parse(NC("{hello:'world'}")));
			TypeAssert<L20nCore.IO.AST.L10n.HashValue>(
		...
		{
			var builder = new L20nCore.Internal.LocaleContext.L10nBuilder();
